from azure.functions import FunctionApp, HttpRequest, HttpResponse, Context
...
@function_app.route(route="checkMatch", auth_level="anonymous")
def checkMatch(req: HttpRequest, context: Context) -> HttpResponse:
